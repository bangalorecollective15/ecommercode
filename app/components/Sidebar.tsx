...
export default function Sidebar({ role }: SidebarProps) {
  ...
  const menu = [
    ...
    },
    {
      ...
      subMenu: [
        { label: "Main category", href: "/admincategory" },
        { label: "subcategory", href: "/subcategory" },
        { label: "Deep subcategory", href: "/subsubcategory" },
      ],
    },
    {
      label: "Products",
      ...
      subMenu: [
        { label: "Add New", href: "/addproducts" },
        { label: "All Products", href: "/listproducts" },
        { label: "Stock", href: "/restock" },
...
{ label: "Coupons", href: "/coupons", icon: <Ticket size={16} /> },
    ...
    { label: "Orders", href: "/orderupdate", icon: <ShoppingCart size={16} /> },
    {
      ...
      subMenu: [
        { label: "Terminal Workspace", href: "/pos" },
        { label: "POS History Ledger", href: "/pos/poslisting" },
      ],
    },
    {
      label: "Reports",
    ...
    },
    {
      ...
      subMenu: [
        { label: "Banner Sections", href: "/hero" },
          { label: "Header banner", href: "/header" },
        { label: "Middle Sections", href: "/middle" },
        { label: "Bottom Sections", href: "/bottom" },
    ...
    },
    {
      ...
      subMenu: [
        { label: "Top Sections", href: "/about-top" },
        { label: "Identity & Mission", href: "/about-identity" },
...
{ label: "Review Approval", href: "/review", icon: <CheckCircle size={16} /> },
    ...
    { label: "Messages enqiry", href: "/messages", icon: <Mail size={16} /> },
