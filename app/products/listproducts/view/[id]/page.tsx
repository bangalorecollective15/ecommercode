                      ...
                      {variations.length > 0 ? variations.map((v) => (
                        <tr key={v.id} className="hover:bg-slate-50/50 transition-colors group">
                          ...
                          <td className="px-8 py-5 text-center">
                            <span className={`text-[10px] px-2 py-1 rounded ${v.stock > 0 ? 'text-green-600 bg-green-50' : 'text-red-600 bg-red-50'}`}>
                                {v.stock} UNITS
                            </span>
                          </td>
                          <td className="px-8 py-5 text-right text-black font-black text-sm group-hover:scale-105 transition-transform">₹{v.price}</td>
                        </tr>
                      )) : (
                        <tr>
                            <td colSpan={4} className="px-8 py-10 text-center text-slate-300 text-[10px] uppercase font-black tracking-widest">No Variations Registry Found</td>
                        </tr>
                      )}
                    </tbody>
                  </table>
