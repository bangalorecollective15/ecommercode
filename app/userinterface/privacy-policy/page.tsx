      ...
      <header className="bg-gradient-to-r from-[#c4a174] to-[#8a6d3b] dark:from-[#b08d60] dark:to-[#6b522b] pt-32 pb-20 px-6 text-center text-white transition-colors duration-300">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-4">
            Privacy Policy<span className="text-black/20 dark:text-black/40">.</span>
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="lg:w-1/4">
            <div className="sticky top-32 bg-white dark:bg-[#111] border border-slate-200 dark:border-[#333] rounded-[2rem] p-8 shadow-sm transition-colors duration-300">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 dark:text-gray-500 mb-6 transition-colors duration-300">Contents</p>
          ...
          {/* --- CONTENT AREA --- */}
          <div className="lg:w-3/4 bg-white dark:bg-black border border-slate-200 dark:border-[#333] rounded-[3rem] p-8 md:p-16 shadow-sm prose prose-slate dark:prose-invert max-w-none transition-colors duration-300">
            
            <section id="intro" className="mb-16">
              <p className="text-lg leading-relaxed text-slate-600 dark:text-gray-300 font-medium transition-colors duration-300">
            ...
            <section id="collection" className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className="p-6 bg-[#f8fafc] dark:bg-[#111] rounded-2xl border border-slate-100 dark:border-[#333] transition-colors duration-300">
                    <h4 className="text-[11px] font-black uppercase tracking-widest text-[#c4a174] mb-2">{item.title}</h4>
                    <p className="text-sm text-slate-500 dark:text-gray-400 leading-relaxed m-0 transition-colors duration-300">{item.desc}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section id="usage" className="mb-16">
              ...
              <ul className="space-y-6 list-none p-0">
                <li className="flex gap-4">
                  ...
                  <div>
                    <strong className="text-slate-800 dark:text-gray-200 uppercase text-[12px] tracking-widest transition-colors duration-300">Tailoring Services:</strong>
                    <p className="text-slate-500 dark:text-gray-400 mt-1 transition-colors duration-300">To process payments, fulfill orders, and create a customized shopping experience including product recommendations.</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#c4a174] shrink-0" />
                  <div>
                    <strong className="text-slate-800 dark:text-gray-200 uppercase text-[12px] tracking-widest transition-colors duration-300">Security & Fraud:</strong>
                    <p className="text-slate-500 dark:text-gray-400 mt-1 transition-colors duration-300">To authenticate accounts and ensure a secure payment experience, protecting against malicious activity.</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#c4a174] shrink-0" />
                  <div>
                    <strong className="text-slate-800 dark:text-gray-200 uppercase text-[12px] tracking-widest transition-colors duration-300">Communication:</strong>
                    <p className="text-slate-500 dark:text-gray-400 mt-1 transition-colors duration-300">To provide customer support and maintain our business relationship with you.</p>
                  </div>
                </li>
              </ul>
            </section>
            ...
            <section id="rights" className="mb-16">
              ...
              <p className="text-slate-500 dark:text-gray-400 mb-6 transition-colors duration-300">Depending on where you live, you may have the following rights regarding your personal data:</p>
              <div className="space-y-4">
                {["Right to Access", "Right to Delete", "Right to Correct", "Right of Portability"].map((right) => (
                  <div key={right} className="flex items-center justify-between p-4 border border-slate-100 dark:border-[#333] rounded-xl hover:border-[#c4a174]/30 dark:hover:border-[#c4a174]/50 transition-colors duration-300">
                    <span className="text-xs font-bold uppercase tracking-widest text-slate-700 dark:text-gray-300 transition-colors duration-300">{right}</span>
            ...
            <footer className="pt-12 border-t border-slate-100 dark:border-[#333] transition-colors duration-300">
              <p className="text-xs text-slate-400 dark:text-gray-500 italic transition-colors duration-300">
                For questions regarding this policy, please reach out to our concierge at <a href="mailto:bangalorecollective15@gmail.com" className="text-[#c4a174] hover:text-[#b08d60] underline transition-colors duration-300">bangalorecollective15@gmail.com</a>.
              </p>
            </footer>
